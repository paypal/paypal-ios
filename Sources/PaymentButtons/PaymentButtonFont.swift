...
enum PaymentButtonFont {
    ...
    public static let paypalPrimaryFont: UIFont = UIFont(name: "PayPalOpen-Regular", size: 14) ??
        .systemFont(ofSize: UIFont.systemFontSize)

    /// The secondary font for sub-heading or alternative text
    public static let paypalSecondaryFont: UIFont = UIFont(name: "PayPalOpen-Regular", size: 12) ??
        .systemFont(ofSize: UIFont.smallSystemFontSize)

    /// Large font of size 18
    public static let paypalSize18Font: UIFont = UIFont(name: "PayPalOpen-Regular", size: 18) ?? 
