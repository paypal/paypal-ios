...
The PayPal iOS SDK supports a minimum deployment target of iOS 14+ and requires Xcode 14.3.1+ and macOS Ventura 13. See our [Client Deprecation policy](https://developer.paypal.com/braintree/docs/guides/client-sdk/deprecation-policy/ios/v5) to plan for updates.
