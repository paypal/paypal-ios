...
| Accept a **PayPal** payment (incl. vault, Pay Later / PayPal Credit) | [PayPal Checkout](paypal-checkout.md) |
| Accept a **Venmo** payment | [Venmo Checkout](venmo-checkout.md) |
| Accept a **card** payment / ACDC (incl. vault) | [Card / ACDC](card-acdc.md) |
| Move an existing 2.x integration to V3 | [Migrate V2 → V3](migrate-v2-to-v3.md) |
| Diagnose a build or integration failure | [Troubleshooting](troubleshooting.md) |
