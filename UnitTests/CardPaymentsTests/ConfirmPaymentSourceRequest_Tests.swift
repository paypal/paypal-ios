...
class ConfirmPaymentSourceRequest_Tests: XCTestCase {
    ...
    func testEncodingPaymentSource_withValidCardDictionary_andVaultWithPurchase_expectsBody() throws {
        let mockOrderID = "mockOrderID"
        let card = Card(
            number: "4032036247327321",
            expirationMonth: "11",
        ...
        let cardRequest = CardRequest(orderID: mockOrderID, card: card, shouldVault: true)
